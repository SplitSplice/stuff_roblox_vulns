...
function Destroy(instance)
	spawn(function()
		if _G.useRemote1 == true then
			_G.remote1:FireServer(instance)
		elseif _G.useRemote1 == false then
			_G.remote2:FireServer(instance)
		else
			print("Invalid useRemote1 option! Please use true or false!")
		end
	end)
end
